...
class VideoDetailPage extends StatefulWidget {
  ...
  VideoDetailPage(
      {Key? key,this.thumbnail, this.title, this.viewCount, this.dayAgo, this.username, this.profile, this.subscribeCount, this.likeCount, this.unlikeCount, this.videoUrl}) : super(key: key);
  @override
